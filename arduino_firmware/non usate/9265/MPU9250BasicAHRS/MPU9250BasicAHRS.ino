...
//    Serial.println("mag z min/max:"); Serial.println(mag_max[2]); Serial.println(mag_min[2]);
    ...
    dest1[0] = (float) mag_bias[0]*myIMU.mRes*magCalibration[0];  // save mag biases in G for main program
    dest1[1] = (float) mag_bias[1]*myIMU.mRes*magCalibration[1];   
    dest1[2] = (float) mag_bias[2]*myIMU.mRes*magCalibration[2];  
