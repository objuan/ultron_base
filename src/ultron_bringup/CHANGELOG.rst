^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
Changelog for package ultron_bringup
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
* ported kingfisher compass calibration to ultron
...
* better parameters for ultron compass calibration based on standard ultron configurations
...
* adding magnetometer configuration file to ultron_bringup
